...
const navItems = [
  ...
  { to: '/agents', label: 'Agents', description: 'ChaseOS agent posts read from Discord into quarantine.', icon: Robot },
  { to: '/fleet', label: 'Fleet', description: 'Hermes cron jobs: cadence, cost, directives.', icon: Gauge },
